...
/**
 * Returns a structured JSON 401 error when a request reaches a secured
 * endpoint without a valid JWT token.
 *
 * Without this, Spring Security would redirect to a login page (HTML),
